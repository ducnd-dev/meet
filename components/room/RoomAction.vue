<template>
    <div class="flex justify-center lg:justify-between actions gap-4">
        <div class="flex justify-between items-center gap-4">
            <img :src="`/images/room/mic-${ statusProp.hasAudio ? 'on' : 'off'}.svg`" class="  object-cover cursor-pointer w-8 md:w-11 h-8 md:h-11 lg:w-14 lg:h-14" @click="handleClick('hasAudio')">
            <img :src="`/images/room/camera-${ statusProp.hasVideo ? 'on':'off'}.svg`" class=" object-cover cursor-pointer w-8 md:w-11 h-8 md:h-11 lg:w-14 lg:h-14" @click="handleClick('hasVideo')">
            <img :src="`/images/room/share-screen-${statusProp.isScreenShare ? 'on':'off' }.svg`" class=" cursor-pointer w-8 md:w-11 h-8 md:h-11 lg:w-14 lg:h-14" @click="handleShare">
            <img src="/images/room/end-call.svg" class=" cursor-pointer w-8 md:w-11 h-8 md:h-11 lg:w-14 lg:h-14" @click="handleClickLeave">
            <div class="relative">
                <img :src="`/images/room/people-${statusProp.people?'on':'off'}.svg`" class="object-cover  cursor-pointer w-8 md:w-11 h-8 md:h-11 lg:w-14 lg:h-14" @click="handleClick('people')">
                <i
            ...
            <img src="/images/room/full-screen-off.svg" class=" object-cover cursor-pointer w-8 md:w-11 h-8 md:h-11 lg:w-14 lg:h-14" @click="fullScreen">
        </div>
    </div>
</template>
<script>
